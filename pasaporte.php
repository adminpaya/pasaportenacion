                                ...
                                fetch("https://api.ocr.space/parse/image", {
                                  ...
                                  .then((data) => {
                                    ...
                                    if(factura ==='no se pudo leer'  || fecha ==='no se pudo leer' || max ==='no se pudo leer'  ){
                                        ...
                                        alert('No se pudo leer correctamento su factura- ingrese los datos como sale en la factura, si la escribe diferente la misma no sera válida para participar')

                                        /*

                                         modalError('Ocurrio un error escaneando su factura- ingrese los datos como sale en la factura, si la escribe diferente la misma no sera válida para participar');
