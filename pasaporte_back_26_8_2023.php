            ...
            <?php 
                ...
                <div class="card-pasaporte">
        			...
        			<div id="step1" class = "right-column ">
        				...
        				<div class="round-buttons">
            				<form onsubmit="procesarImagen(event)" class="form-pasaporte"  id="envia_factura" >
            					<div id="pulsebtn">  
                				    <label for="my-file-input" class="custom-file-upload pulsebutton"  onclick="envieImagen()" >
        			...
        			<div class = "right-column"  id="step2" style ="display : none" >
                        ...
                        <input type="text" name="f-numero" id="f-numero" value="" class="text" disabled>
                        <label for="f-fecha">fecha</label>
                        <input type="date" name="f-fecha" id="f-fecha" class="text" disabled>
                        <label for="f-monto">monto</label>
                        <input type="text" name="f-monto" id="f-monto" class="text" disabled>
                        <p><br></p>
...
<script type="text/javascript">
   ...
   const showSubmit = () =>{
    ...
    async function procesarImagenPerfil(event) {
          ...
          */
          ...
          if (compressedFile.type == "image/png" || compressedFile.type == "image/jpg" || compressedFile.type == "image/jpeg") {
            ...
            fetch("https://tamitut.com/PAYA/pasaporte/perfil_db.php?id=<?php echo $id; ?>", {
              method: "POST",
              body: formData,
            })
              .then((response) => {
              ...
              .then((data) => {
                ...
                const facturaRegex = /[A-Z]{2,}\d+-\d+/;    // esta expresion regular agarra mas facturas
                //const facturaRegex = /TF[A-Z]{2,}\d+-\d+/;
    ...
    async function  getProduct(key,contador,precio,func){
       ...
       if(func === 'GET')
            peticion.open("POST", "https://tamitut.com/PAYA/facturas/nacion_crear_productos_externos_db.php?is=GET",true);
       if(func === 'PUT')
    ...
    function  myFunction(event){
       ...
       // peticion.open("GET", "https://tamitut.com/PAYA/facturas/rdm_db.php?addRuc="+ ruc_send +"&addTotal="+ document.getElementById('addTotal').value +"&addFecha=" + document.getElementById('addFecha').value + "&addDate=" + document.getElementById('addDate').value + "&addNumero=" + document.getElementById('addNumero').value);
        ...
        peticion.open("POST", "https://tamitut.com/PAYA/pasaporte/pasaporte_db.php",true);
        peticion.onload = function () {
